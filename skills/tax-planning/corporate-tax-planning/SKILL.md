...
metadata:
  hermes:
    ...
    related_skills: [coze-tax-agent-prompt, reference-material-integration, compliant-accounting, enterprise-diagnostic, holding-company-firewall, tax-planning/holding-company-firewall, tax-planning/equity-architecture-guide]
---
