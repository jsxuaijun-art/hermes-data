...
name: officecli
version: 1.0.0
display_name: OfficeCLI 办公文档工具
display_name_en: OfficeCLI Office Document Toolkit
description: Create, analyze, proofread, and modify Office documents (.docx, .xlsx, .pptx) using the officecli CLI tool. Use when the user wants to create, inspect, check formatting, find issues, add charts, or modify Office documents.
description_zh: 使用 officecli 命令行工具创建、分析、校对和修改 Word、Excel 与 PowerPoint 文档，适用于文档生成、内容检查、格式修正、问题排查及图表编辑。
description_en: Create, analyze, proofread, and modify Word, Excel, and PowerPoint documents with the officecli command-line tool, including document generation, content inspection, formatting fixes, issue detection, and chart editing.
metadata:
  author: linxianmiao
---
