...
```bash
# ~/.hermes/sync-push-wsl.sh
# 从 ~/.hermes/ → /mnt/c/Users/Admin/hermes-sync/ → git push
cp -f ~/.hermes/SOUL.md /mnt/c/Users/Admin/hermes-sync/
rsync -a --delete ~/.hermes/memories/ /mnt/c/Users/Admin/hermes-sync/memories/
rsync -a --delete ~/.hermes/skills/ /mnt/c/Users/Admin/hermes-sync/skills/
cd /mnt/c/Users/Admin/hermes-sync
git add -A && git commit -m "sync WSL端 $(date)" && git push
```

#### 拉取（上班时）

```bash
# ~/.hermes/sync-pull-wsl.sh
cd /mnt/c/Users/Admin/hermes-sync
git pull origin main
cp -f SOUL.md config.yaml ~/.hermes/
rsync -a --delete memories/ ~/.hermes/memories/
