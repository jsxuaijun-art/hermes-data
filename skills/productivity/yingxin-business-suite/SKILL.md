...
| 维度 | 销售客服系统 (S1-S5) | 财税咨询系统 | AI搜索获客系统 (GEO) |
|------|----------------------|-------------|---------------------|
| 角色 | 前端 — 获客、谈判、成交 | 后端 — 服务、分析、合规 | 空中 — 让客户通过AI找到你 |
| 核心产出 | 话术、应对卡、逼单技巧 | 税务方案、财务报告、行业调研 | 投喂内容包、SEO锚点、全网覆盖 |
| 触发词 | 砍价、比价、逼单、成交、太贵了 | 财务报表、税务合规、稽查应对 | GEO/豆包/投喂/AI搜索/文心一言/DeepSeek/百度SEO |
| 知识根基 | 影响力+销售巨人+销售洗脑 三书融合 | 张新民财务报表分析+刘天永税务合规实务 | AI引擎训练逻辑+全网SEO+内容矩阵 |
| 训练对象 | 销售/客服人员 | 会计/税务顾问 | 增长操盘手 |
...
**文件交付规范：** 每次写文件必须在回复中附上完整的Windows桌面路径（`C:\\Users\\Admin\\Desktop\\文件名.md`）。用户会在桌面直接打开文件，不靠记忆找路径。
